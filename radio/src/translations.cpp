...
const pm_char STR_PPM_TRAINER[] PROGMEM = TR_PPM_TRAINER;
  ...
  const pm_char STR_SERIAL_INPUT[] PROGMEM = TR_SERIAL_INPUT;
#endif
...
#if defined(USB_CONTROL)
  const pm_char STR_MENUSERIAL[] PROGMEM = TR_MENUSERIAL;
#endif
...
const pm_char STR_BLCOLOR[]  PROGMEM = TR_BLCOLOR;
  ...
  #if defined(USB_CONTROL)
    const pm_char STR_SERIAL[] PROGMEM = TR_SERIAL;
  #endif
...
#if defined(USB_CONTROL)
  const pm_char STR_MENU_SERIAL[] PROGMEM = TR_MENU_SERIAL;
#endif
